        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-purple-50">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div className="text-center mb-6">
                        <h1 className="text-4xl font-bold text-gray-900 mb-4">
                            🎤 Khmer Public Speaking
                        </h1>
                        <p className="text-gray-700 text-lg max-w-3xl mx-auto">
                            Develop confidence in delivering presentations and storytelling.
                            Master oratory skills and public speaking techniques in Khmer.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <p className="text-lg font-bold text-gray-900">55 min</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Link
                        href="/lessons/advanced/transcription"
                        className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors"
                    >
                        Next: Transcription
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Public Speaking Content Coming Soon</h3>
                    <p className="text-gray-600">This lesson will include presentation techniques, storytelling skills, and public speaking practice in Khmer.</p>
                </div>
            </div>
        </div>
    );
