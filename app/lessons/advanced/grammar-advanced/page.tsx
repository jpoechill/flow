        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-purple-50">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-700 text-lg max-w-3xl mx-auto">
                            Dissect sentence endings, modality, and formal syntax.
                            Master linguistic precision in advanced Khmer grammar.
                        </p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Advanced Grammar Content Coming Soon</h3>
                    <p className="text-gray-600">This lesson will include advanced grammar patterns, particles, and linguistic analysis.</p>
                </div>
            </div>
        </div>
    );
...
export default GrammarAdvancedPage; 