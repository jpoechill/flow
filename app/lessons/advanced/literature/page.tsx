        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-purple-50">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div className="text-center mb-6">
                        <h1 className="text-4xl font-bold text-gray-900 mb-4">
                            📖 Khmer Literature & Nonfiction
                        </h1>
                        <p className="text-gray-700 text-lg max-w-3xl mx-auto">
                            Read and analyze text types, tones, and cultural context.
                            Deep dive into Khmer literary traditions and advanced reading comprehension.
                        </p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Literature Content Coming Soon</h3>
                    <p className="text-gray-600">This lesson will include advanced reading materials, literary analysis, and cultural context.</p>
                </div>
            </div>
        </div>
    );
