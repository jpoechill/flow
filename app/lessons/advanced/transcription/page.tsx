        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-purple-50">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div className="text-center mb-6">
                        <h1 className="text-4xl font-bold text-gray-900 mb-4">
                            📝 Transcription & Summarization Practice
                        </h1>
                        <p className="text-gray-700 text-lg max-w-3xl mx-auto">
                            Listen to long-form content and produce accurate summaries.
                            Master academic skills and advanced comprehension techniques.
                        </p>
                    </div>
                ...
                <div className="flex items-center justify-between mb-8">
                    <Link
                        href="/lessons/advanced/public-speaking"
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Transcription Content Coming Soon</h3>
                    <p className="text-gray-600">This lesson will include long-form listening exercises, transcription practice, and summarization skills.</p>
                </div>
            </div>
        </div>
    );
